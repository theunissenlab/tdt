...
myBlock = 'wn_test_mic_calib_precis_filt3';
save_path = 'C:\Documents and Settings\Sepehr\My Documents\MATLAB\mic_calibration_data\';
...
saveas(h,[save_path,'tf_wn_precis_mic'], 'fig');
saveas(h,[save_path,'tf_wn_precis_mic'], 'pdf');
saveas(h,[save_path,'tf_wn_precis_mic'], 'eps');

% 3. coherence
h = figure(12);
mscohere(mic_input_precis,spkr_output_precis,2048,[],[],fsamp);
title('Coherence function for precision mic');
saveas(h,[save_path,'coh_wn_precis_mic'], 'fig');
saveas(h,[save_path,'coh_wn_precis_mic'], 'pdf');
saveas(h,[save_path,'coh_wn_precis_mic'], 'eps');
...
saveas(h,[save_path,'xcorr_wn_precis_mic'], 'fig');
saveas(h,[save_path,'xcorr_wn_precis_mic'], 'pdf');
saveas(h,[save_path,'xcorr_wn_precis_mic'], 'eps');
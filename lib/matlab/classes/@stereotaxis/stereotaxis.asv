function s = stereotaxis(varargin)
%% BLOCK Constructor function for stereotaxis object
% b = stereotaxis(session,stereotaxisnumber,starttime,protocol,channelmap,experimenter)
...
%% If single argument of class stereotaxis, return it
elseif nargin == 1
   if (isa(varargin{1},'stereotaxis'))
        b = varargin{1};
        return
   else

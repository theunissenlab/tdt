...
% b = tdt_block(blockname,tank,starttime,endtime)
...
classspec = {...
            'name'          'char'          true        '';...
            'tank'          'tank'          true        [];...
            'starttime'     'datetime'      false       0;...
            'endtime'       'datetime'      false       0 ...
    };
...
case 2
    ...
    for jj = 1:nfields
        if assigned(jj)
            ...
            t.(classspec(jj).name) = feval(classspec(jj).class,...
                classspec(jj).default);
            % This doesn't work, bc cast.m only supports built-in classes
